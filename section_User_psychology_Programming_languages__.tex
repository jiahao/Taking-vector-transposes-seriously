...
\paragraph{Grassmann (1844) - Ausdehnungslehre I}
...
A single term, written $[A().B]$ in Grassmann's notation, is a ,,Produkt mit ein Lücke`` (product with one opening), which is generalized to multiple openings in Ausdehnungslehre II. Such a single time is what we would today call an outer product of two vectors, or a rank 1 matrix.

Ausdehnungslehre I introduces the concept of outer multiplication (,,äussere Multiplikation``) (\S 34, p.57, p.81English) as what we would today call the exterior product or wedge product. The term ``outer product'' (,,äusseres Produkt``) appears in \S 36, p. 60, p. 84English.

\paragraph{Grassmann (1847)~\cite{Grassmann1847} - ,,Geometrische Analyse``}

\S 7 p. 334 English, introduces the inner product $a \times b$, and the inner square $a^2 = a \times a$.
...
\paragraph{Grassmann (1862)~\cite{Grassmann1862} - Ausdehnungslehre II.}
