\section{Old Introduction (Proposed) }
...
%TODO unital algebra
%
%TODO indexing is more fundamanetal than linalg. You can index vectors of strings, for example.
...
%\end{enumerate}
%
%TODO T2 requires a cast of v vector into (v,) matrix. then you transpose it.
%
...
\section{Matrix slices and column vectors}
